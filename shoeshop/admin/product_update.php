...
$data=[
		'product_name'=>$product_name,'product_code'=>$product_code,'product_brand_id'=>$product_brand_id,'product_category_id'=>$product_category_id,'product_gender_id'=>$product_gender_id,'product_price'=>$product_price,'product_photo'=>$product_photo,'product_description'=>$product_description,'id'=>$id,];
